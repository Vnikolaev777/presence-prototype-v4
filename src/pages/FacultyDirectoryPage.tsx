...
const TEACHERS = [
  {
    ...
    dept: 'Humanities',
    room: 'Room 214',
    email: 'j.holloway@oakwoodhigh.org',
    joined: 'Apr 2026',
    isNew: true,
  ...
  },
  {
    ...
    dept: 'Humanities',
    room: 'Room 216',
    email: 's.johnson@oakwoodhigh.org',
    joined: 'Sep 2021',
    isNew: false,
